...
public class SwerveModule {
  ...
  public SwerveModule(
    ...
    CANcoderConfiguration steerEncoderConfig = DriveTrain.ctreConfig.steerEncoderConfig;
    TalonFXConfiguration steerMotorConfig = DriveTrain.ctreConfig.steerMotorConfig;
    ...
    m_driveMotor.getConfigurator().apply(DriveTrain.ctreConfig.driveMotorConfig);
